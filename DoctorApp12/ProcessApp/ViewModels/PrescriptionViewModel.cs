...
namespace ProcessApp.ViewModels
{
    public class PrescriptionViewModel : BindableBase
    {
        ...
        private int aM = MenuViewModel.Ps[MenuViewModel.SIndex].AM;
        public int AM
        {
            get => aM;
        ...
        private int bM = MenuViewModel.Ps[MenuViewModel.SIndex].BM;
        public int BM
        {
            get => bM;
        ...
        private int cM = MenuViewModel.Ps[MenuViewModel.SIndex].CM;
        public int CM
        {
            get => cM;
